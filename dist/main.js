...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"buildTasks\": () => (/* binding */ buildTasks),\n/* harmony export */   \"newTask\": () => (/* binding */ newTask)\n/* harmony export */ });\n/* harmony import */ var _appLogic__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./appLogic */ \"./src/appLogic.js\");\n/* harmony import */ var _buildPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./buildPage */ \"./src/buildPage.js\");\n\n\n\nconst clearDisplay = () => {\n  const selectDisplay = document.querySelector('.display');\n  selectDisplay.innerHTML = '';\n};\n\nfunction buildTasks() {\n// Creates cards corresponding to each task from taskArray\n  clearDisplay();\n  const test = (() => {\n    const test = (0,_appLogic__WEBPACK_IMPORTED_MODULE_0__.toDoFactory)('test', 'this is a test', 'NOW!', 'IMPORTANT!');\n    _appLogic__WEBPACK_IMPORTED_MODULE_0__.tasks.taskArray.push(test);\n    console.log(_appLogic__WEBPACK_IMPORTED_MODULE_0__.tasks.taskArray);\n  })();\n  console.log('Building tasks!');\n  for (let i = 0; i < _appLogic__WEBPACK_IMPORTED_MODULE_0__.tasks.taskArray.length; i += 1) {\n    (0,_buildPage__WEBPACK_IMPORTED_MODULE_1__.builder)('div', '.display', 'task-card', undefined, undefined, undefined, `task-card-${i}`);\n    (0,_buildPage__WEBPACK_IMPORTED_MODULE_1__.builder)('div', `#task-card-${i}`, 'title-div', undefined, undefined, undefined, `title-div-${i}`);\n    (0,_buildPage__WEBPACK_IMPORTED_MODULE_1__.builder)('h3', `#title-div-${i}`, `task-${i}-title`, undefined, undefined, _appLogic__WEBPACK_IMPORTED_MODULE_0__.tasks.taskArray[i].title);\n    (0,_buildPage__WEBPACK_IMPORTED_MODULE_1__.builder)('p', `#title-div-${i}`, `task-${i}-due`, undefined, undefined, _appLogic__WEBPACK_IMPORTED_MODULE_0__.tasks.taskArray[i].dueDate);\n  }\n}\n\nfunction newTask() {\n  clearDisplay();\n  (0,_buildPage__WEBPACK_IMPORTED_MODULE_1__.builder)('input', '.display', 'task-title', 'text', undefined, undefined, undefined, 'Task name');\n  (0,_buildPage__WEBPACK_IMPORTED_MODULE_1__.builder)('input', '.display', 'task-date', 'date');\n  (0,_buildPage__WEBPACK_IMPORTED_MODULE_1__.builder)('div', '.display', 'priority-div');\n  (0,_buildPage__WEBPACK_IMPORTED_MODULE_1__.builder)('input', '.priority-div', 'select-priority', 'button', 'Urgent', undefined, 'urgent');\n  (0,_buildPage__WEBPACK_IMPORTED_MODULE_1__.builder)('input', '.priority-div', 'select-priority', 'button', 'Normal', undefined, 'normal');\n  (0,_buildPage__WEBPACK_IMPORTED_MODULE_1__.builder)('input', '.priority-div', 'select-priority', 'button', 'Low', undefined, 'low');\n  (0,_buildPage__WEBPACK_IMPORTED_MODULE_1__.builder)('input', '.display', 'notes', 'text', undefined, undefined, undefined, 'Notes');\n  (0,_buildPage__WEBPACK_IMPORTED_MODULE_1__.builder)('input', '.display', 'subtask-btn', 'button', 'Add subtask');\n\n  \n}\n\n\n\n\n//# sourceURL=webpack://todo/./src/tasks.js?");
